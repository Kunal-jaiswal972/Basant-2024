...
export const mainCoordinators = [
  ...
  },
  {
    ...
    imgSrc: "/media/coordinators/Abhishek.jpeg",
    roles: ["Hospitality Team"],
    department: "Mechanical Engineering",
  },
  {
    name: "Ayush Kumar",
    imgSrc: "/media/coordinators/Ayush.jpeg",
    roles: ["Hospitality Team"],
    department: "Petroleum Engineering",
  },
  {
    name: "Prajjwal Gurjar",
    imgSrc: "/media/coordinators/Prajjwal.jpeg",
    roles: ["Security Team"],
    department: "Mechanical Engineering",
  },
  {
    name: "Ratikesh Kumar Rajak",
    imgSrc: "/media/coordinators/Ratikesh.jpeg",
    roles: ["Operations and Logistics Team"],
    department: "Mechanical Engineering",
  },
  {
    name: "Tushar Raj",
    imgSrc: "/media/coordinators/Tushar.jpeg",
    roles: ["Sponsorship Team"],
    department: "Applied Geophysics",
  },
  {
    name: "Yash Tarun",
    imgSrc: "/media/coordinators/Tarun.jpeg",
    roles: ["Sponsorship Team"],
    department: "Electrical Engineering",
  },
  {
    name: "Rounak Raj",
    imgSrc: "/media/coordinators/Rounak.jpeg",
    roles: ["Public Relations Team"],
    department: "Computer Science and Engineering",
  },
  {
    name: "Yash Agrawal",
    imgSrc: "/media/coordinators/Yash.jpeg",
    roles: ["Sponsorship Team"],
